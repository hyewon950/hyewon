		...
		(function (st, state) {
			...
			st[0].onclick = function () {
				...
				switch(state) {
					case "seoul":
//						location.href="#seoul";
						location.href="resultregion.do?clocal=서울";
			
						current = state;
						break;
					case "gygg":
						location.href="resultregion.do?clocal=경기";
						current = state;
						break;
					case "incheon":
						location.href="resultregion.do?clocal=인천";
						current = state;
						break;
					case "gangwon":
						location.href="resultregion.do?clocal=강원";
						current = state;
						break;
					case "chungbuk":
						location.href="resultregion.do?clocal=충청북도";
						current = state;
						break;
					case "chungnam":
						location.href="resultregion.do?clocal=충청남도";
						current = state;
						break;
					case "daejeon":
						location.href="resultregion.do?clocal=대전";
						current = state;
						break;
					case "sejong":
						location.href="resultregion.do?clocal=세종";
						current = state;
						break;
					case "jeonbuk":
						location.href="resultregion.do?clocal=전라북도";
						current = state;
						break;
					case "gwangju":
						location.href="resultregion.do?clocal=광주";
						current = state;
						break;
					case "jeonnam":
						location.href="resultregion.do?clocal=전라남도";
						current = state;
						break;
					case "gyeongbuk":
						location.href="resultregion.do?clocal=경상북도";
						current = state;
						break;
					case "daegu":
						location.href="resultregion.do?clocal=대구";
						current = state;
						break;
					case "gyeongnam":
						location.href="resultregion.do?clocal=경상남도";
						current = state;
						break;
					case "ulsan":
						location.href="resultregion.do?clocal=울산";
						current = state;
						break;
					case "busan":
						location.href="resultregion.do?clocal=부산";
						current = state;
						break;
					case "jeju":
						location.href="resultregion.do?clocal=제주";
						current = state;
						break;
