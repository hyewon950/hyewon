...
<body>
    ...
    <div class="container">
        <form id="form_data" method="POST">
            ...
            <select id="sl">
                ...
                <option value="productBoard"
                >용품 추천 게시판</option>
                <option value="recipeBoard">레시피 게시판</option>
                <option value="guideBoard">가이드 게시판</option>
            </select>
            <input type="hidden" name="bType" id="bType" />   
                ...
                <tbody>
                <c:url var="board" value="updateBoard.do">
                    <tr>
                        <th>제목 : </th>
                        <td><input type="text" name="bTitle" id="bTitle" class="form-control" value="${board.bTitle }"></td>
                    </tr>
                    <tr>
                        <th>작성자 : </th>
                        <td>${board.mId }</td>
                    ...
                    <tr>
                        <th>내용 : </th>
                        <td><textarea cols="60" rows="10" name="bDetail" id="bDetail" class="form-control" value="${board.bDetail }"></textarea></td>
                    </tr>
                    <tr>
                        <th>첨부 파일 </th>
    ...
    <Script>
        $("#btn1").click(function() {
            var Type = $("#sl option:selected").val();
            $("#bType").val(Type);
        })
    </Script>
