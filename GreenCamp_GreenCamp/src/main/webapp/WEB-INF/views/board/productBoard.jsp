	...
	<div class="container">
		...
		<div id="searchArea" align="center">
			<form class="form-inline text-center" id="test" action="bsearch.do"
				...
				<input type="hidden" name="boardType" value="용품추천" />
				...
				<c:forEach var="board" items="${list }">
					<tr>
						...
						<td><c:url var="detail" value="detailBoard.do">
								...
								<c:param name="boardType" value="용품" />
			...
			<tr align="center" height="20">
				<td colspan="6">
					<!-- [이전] --> <c:if test="${pi.currentPage <= 1 }">
						...
						<c:url var="before" value="plist.do">
						...
						<c:if test="${p ne pi.currentPage }">
							<c:url var="pagination" value="plist.do">
					...
					<c:if test="${pi. currentPage < pi.maxPage }">
						<c:url var="after" value="plist.do">
							<c:param name="page" value="${pi.currentPage + 1 }" />
						</c:url>
						<a href="${after }">[다음]</a> &nbsp;
						</c:if>
