...
<div class="wrapper fadeInDown">
		<div id="formContent">
			...
			<!-- Login Form -->
			<form action="findIdSuccess.do" method="post" id="formInfo"> 
				<input type="text" id="mName" class="fadeIn second" name="mName"
					placeholder="이름">

				<div class="row">
					<div class="col-xs-8">
						<input type="text" id="mEmail" class="fadeIn third" name="mEmail"
							placeholder="이메일">
					</div>
					<div class="col-xs-2">
						<!-- 인증번호 받기 버튼(보류)-->
						<input type="button" class="fadeIn fourth" id="emailBtn"
						style="width: 100px; height: 50px;" value="전송 하기">
					</div>
				</div>
                    ...
                    <div class="col-xs-2">
                    <input type="button" class="fadeIn fourth" id="Check" value="인증 확인" style="width: 100px; height: 50px;">
                  </div>
                    </div>
			...
			<!-- Remind Passowrd -->
			<div id="formFooter">
				<a class="underlineHover" href="home.do">메인페이지로 돌아가기</a>
			</div>
		</div>
	</div>
