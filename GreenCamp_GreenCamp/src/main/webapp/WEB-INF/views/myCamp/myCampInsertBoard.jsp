	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<article class="post">
				...
				<span class="mycampmainimg"> <!-- <img
					src="../../resources/css/myCampcss/assets/css/images/pic01.jpg"
					width="400px;" height="300px"> -->
				</span>


				<form id="mycinsertform" name="mycinsertform"
					enctype="multipart/form-data" action="mycinsertboard.do"
					method="post">
					<div class="row">
						<div class="col-md-6">
						...
						<input type="hidden" id="id" name="id" value="캬캬캬id">
					</div>
					<br>
					<div class="form-group" style="margin-right: 70px">
						<label for="mycTitle">글제목</label> <input type="text"
							class="form-control" name="mycTitle" id="mycTitle"
							required="required">
					</div>
					<br>
					<div class="form-group" style="margin-right: 70px">
						<label for="mycPlace">위치</label> <select class="select">
            ...
            $sel.change(function() {
                ...
                $("#oneaddr").val(pname);
					...
					<div class="form-group" style="margin-right: 70px">
						...
						<textarea class="form-control" rows="10" name="mycDetail"
							id="mycDetail" required="required"></textarea>
					</div>
					<br>
					<div class="form-group" style="margin-right: 70px">
						<label for="mycTag">태그</label>
						<!-- <input type="text" class="form-control" name ="mycTag" id="mycTag" value="공기 좋은" required="required">  -->
						...
						<div class="myCampTag">
							<fieldset>
								...
								<button type="button" value="#차대기편한" id="inputs14"
									class="inputs">차대기편한</button>
								...
								<button type="button" value="#분위기있는" id="inputs18"
									class="inputs">분위기있는</button>
					...
					<label for="File">첨부파일</label>
					 ...
					 <i class="far fa-images"></i> 이미지 추가하기</a>
					</div>
					...
					<div class="card shadow mb-4">
						<div class="card-header">
							<div id="filebox1" class="filebox" style="display: none;">
								<input id="upload-name1" class="upload-name" value="파일선택"
									...
									class="image-label">업로드</label> <input type="file" id="image1"
									name="fileImage" class="upload-hidden" disabled="disabled">
							...
							<div id="filebox2" class="filebox" style="display: none">
								<input id="upload-name2" class="upload-name" value="파일선택"
									...
									class="image-label">업로드</label> <input type="file" id="image2"
									name="fileImage" class="upload-hidden" disabled="disabled">
							...
							<div id="filebox3" class="filebox" style="display: none">
								<input id="upload-name3" class="upload-name" value="파일선택"
									...
									class="image-label">업로드</label> <input type="file" id="image3"
									name="fileImage" class="upload-hidden" disabled="disabled">
						...
						<div class="card-body row">
							<div id="img-box1" class="img-box"
								...
								<p>첫번째 사진</p>
								<img src="../../resources/imgs/hi.jpg" style="width:250px;" id="input-img" />
							</div>
							...
							<div id="img-box3" class="img-box"
								style="height: 70%; margin: 30px auto; visibility: hidden">
								<p>세번째 사진</p>
								<img src="../../resources/imgs/hi2.jpg" style="width:250px;" id="input-img" />
							</div>
						</div>
					</div> -->
					...
					<div class="form-group" required="required">
						...
						<label for="File">첨부파일</label> <a href="javascript:void(0);"
							onclick="addImage();"> <i class="far fa-images"></i> 이미지 추가하기
							(이미지를 더추가하시려면 눌러주세요)
						</a>
					</div>
					...
					<div class="card shadow mb-4">
						<div class="card-header">
							<div id="filebox1" class="filebox">
								...
								<label for="image1" class="image-label">첫번째 사진 (메인사진 필수
									등록)</label> <input type="file" id="image1" name="fileImage"
									required="required">
								<!-- <button class="btn btn-success" id="remove1">취소</button> -->
								&nbsp;&nbsp;<a id="close_link" href="javascript:void(0);"
							...
							<div id="filebox2" class="filebox" style="display: none">
								<!-- <input id="upload-name2" class="upload-name" value="파일선택"
									disabled="disabled"> -->
								<label for="image2" class="image-label">두번째 사진</label> <input
									type="file" id="image2" name="fileImage" class="upload-hidden"
									disabled="disabled" required="required">
								<!-- <button class="btn btn-success" id="remove2">취소</button>  -->
								&nbsp;&nbsp;<a id="close_link" href="javascript:void(0);"
									onclick="removeImage2();"><i
							...
							<div id="filebox3" class="filebox" style="display: none">
								<!-- <input id="upload-name3" class="upload-name" value="파일선택"
									disabled="disabled"> -->
								<label for="image3" class="image-label">세번째 사진</label> <input
									type="file" id="image3" name="fileImage" class="upload-hidden"
									disabled="disabled" required="required">
								<!-- <button class="btn btn-success" id="remove3">취소</button> -->
								&nbsp;&nbsp;<a id="close_link" href="javascript:void(0);"
									onclick="removeImage3();"><i
						...
						<div class="card-body row">
							<div id="img-box1" class="img-box"
								...
								<p>첫번째 사진 (메인 사진 등록)</p>
								<img src="../../resources/imgs/noimage.jpg"
									style="width: 250px;" id="input-img" />
							</div>
							<div id="img-box2" class="img-box"
								style="height: 70%; margin: 30px auto; visibility: hidden">
								<p>두번째 사진</p>
					...
					<!--  <div class="form-group">
						<label for="File">첨부파일</label> <input multiple="multiple"
							type="file" name="file"> <input type="button"
							value="파일추가" onclick="addFile();"> <input type="button"
							value="파일삭제" onclick="delFile();">
					</div>
 ...
 -->
					...
					<div class="center-block" style='width: 400px' align="center">
						<input type="submit" class="btn btn-info" value="등록하기"
							...
							style="background-color: #2dcb73">&nbsp;&nbsp; <input
							type="button" class="btn btn-info" value="취소" id="cancelBtn"
	 ...
	 */
		...
		$('#image1').on('change', function() {
			...
			if ($.inArray(ext, [ 'gif', 'png', 'jpg', 'jpeg' ]) == -1) {
				$("#image1").val("");
				window.alert('잘못 선택하셨습니다. 다시 선택해주세요.');
			} else {
