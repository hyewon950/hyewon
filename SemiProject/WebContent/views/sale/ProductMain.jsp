...
<body>
	...
	<section>
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-5" id="placebox">
						<form action="/productSearch">
							...
							<label for="place">재배지</label>
							<input type="text" id="place" list="placeList" name="searchKey" placeholder=" 재배지 선택">
									...
									<a href="/productDetail?saleNo=${saleList[0].saleNo}&prdClass=${saleList[0].prdClass}">
										<c:choose>
											<c:when test="${empty bestImage[0].getSaleImgName()}">
												<img src="/img/logo_bg.jpg" class="d-block w-100" alt="상품 이미지 없음" width="300" height="300" style="float: left">
												BEST 1
												<div class="overlay">
												<div class="description"><c:out value="${saleList[0].saleSubject}" /></div>
												</div>
											</c:when>
											<c:when test="${not empty bestImage[0].getSaleImgName()}">
												<img src="/img/${bestImage[0].getSaleImgName() }" width="100%" height="100%" style="float: left">
												BEST 1
												<div class="overlay">
												<div class="description"><c:out value="${saleList[0].saleSubject}" /></div>
												</div>
									...
									<a href="/productDetail?saleNo=${saleList[1].saleNo}&prdClass=${saleList[1].prdClass}">
										<c:choose>
											<c:when test="${empty bestImage[1].getSaleImgName()}">
												...
												BEST 2
												<div class="overlay">
												<div class="description"><c:out value="${saleList[1].saleSubject}" /></div>
												</div>
											</c:when>
											<c:when test="${not empty bestImage[1].getSaleImgName()}">
												<img src="/img/${bestImage[1].getSaleImgName() }" width="100%" height="100%" style="float: left">
												BEST 2
												<div class="overlay">
												<div class="description"><c:out value="${saleList[1].saleSubject}" /></div>
												</div>
									...
									<a href="/productDetail?saleNo=${saleList[2].saleNo}&prdClass=${saleList[2].prdClass}">
										<c:choose>
											<c:when test="${empty bestImage[2].getSaleImgName()}">
												...
												BEST 3
												<div class="overlay">
												<div class="description"><c:out value="${saleList[2].saleSubject}" /></div>
												</div>
											</c:when>
											<c:when test="${not empty bestImage[2].getSaleImgName()}">
												<img src="/img/${bestImage[2].getSaleImgName() }" width="100%" height="100%" style="float: left">
												BEST 3
												<div class="overlay">
												<div class="description"><c:out value="${saleList[2].saleSubject}" /></div>
												</div>
			...
			<br><br><hr><br>
			<!--모든 상품들-->
			<div class="row" align="center" id="pro">
				<!--카드형식-->
				<c:forEach items="${pageData.pageList }" var="sale" varStatus="i">
					<div class="col-sm-6 col-md-3" id="productList">
						<a href="/productDetail?saleNo=${sale.saleNo}&prdClass=${sale.prdClass}">
							<div class="card" style="width: 23rem;">
								<img src="/img/${sale.saleImgName} " class="card-img-top" alt="...">
								<div class="card-body">
			...
			<div class="justify-content-center" style="text-align: center;">
				<ul class="pagination justify-content-center" style="clear: both;">${pageData.pageNavi}</ul>
			</div>
		</div>
	</section>
	<br><br>
