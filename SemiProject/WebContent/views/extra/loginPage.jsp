...
<div class="wrapper fadeInDown">
              <div id="formContent">
                ...
                <!-- Login Form -->
                <form action="/loginTest" method="post" id="loginForm">
                  <input type="text" id="login" class="fadeIn second" name="id" placeholder="아이디를 입력해주세요">
                 ...
                 <br><br><a style="color: red"><label id="idChcekArea"></label></a><!-- 중복체크 -->
                  <br><br><input type="button" class="fadeIn fourth" value="로그인" id="submitBtn">
                </form>
