...
<body>
    ...
    <section>
        <div class="container">
            <span class="head">
                ${community.postKinds} 작성
            </span>
            <hr>
            <div class="col-sm-12 col-md-12">
                <form action="/modifyCommunityCommit" method="post" enctype="multipart/form-data">
                	<input type="hidden">
                    <label for="subject">${community.postSubject }</label>
                    <input type="text" id="subject" name="subject" size="20px;" value="${community.postSubject }">
                    <input type= "hidden" name="postNo" value="${community.postNo }">
                    <input type= "hidden" name="postKinds" value="${community.postKinds}">
                        <fieldset>
                            <label for="communityKind">게시판종류</label>
                            <select id="communityKind">
                    ...
                    <!--<textarea id="content" name="content" rows="20" cols=90%; placeholder="내용을 입력해주세요"></textarea>-->
                     <textarea id="summernote" name="editordata" class="summernote">${community.postContent }</textarea>
                    <br>
