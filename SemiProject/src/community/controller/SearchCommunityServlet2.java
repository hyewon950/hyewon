 ...
 */
@WebServlet("/searchCommunity2")
public class SearchCommunityServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SearchCommunityServlet2() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String postKinds = request.getParameter("searchOption");
