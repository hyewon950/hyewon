...
<%-- <%
	//ArrayList<Member> list = (ArrayList<Member>)request.getAttribute("list");  자바코드
%> --%>    
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<table border="1">
		<tr>
			<th>아이디</th><th>이름</th><th>나이</th><th>이메일</th><th>휴대폰</th><th>주소</th><th>성별</th><th>취미</th><th>가입날짜</th>
		</tr>
